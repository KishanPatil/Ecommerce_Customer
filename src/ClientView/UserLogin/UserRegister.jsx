  ...
  return (
    <div>
      ...
      <div className="register-body fluid">
        <h2 className='mb-5 text-center mt-3'>Register</h2>
        <form className='container' onSubmit={handleSubmit}>
          ...
          <div className="btns ml-5">
            <button type="submit" className='btn btn-dark ml-5' >Register</button>
            <button type="cancel" className='btn btn-dark '><Link to='/' style={{ textDecoration: 'none', color: 'white' }}>Cancel</Link></button>
          </div>
        </form>
      </div>
    </div>
